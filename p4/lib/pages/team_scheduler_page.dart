...
class TeamSchedulerPageState extends State<TeamSchedulerPage> {
  ...
  Future<void> _loadMilestones() async {
    ...
    try {
      ...
      for (var data in response) {
        // 날짜 파싱 시 toLocal()을 사용하여 로컬 시간대로 변환 유지
  ...
  void addMilestone() {
    ...
    // toLocal()을 사용하여 현재 시간대의 날짜로 초기화
    DateTime selectedStartDate = DateTime.now().toLocal();
    DateTime selectedEndDate = DateTime.now().toLocal().add(const Duration(days: 7));
    ...
    showDialog(
      ...
      builder: (ctx) => StatefulBuilder(
        builder: (context, setStateDialog) {
          ...
          // 💡 [수정] pickDate 함수를 StatefulBuilder 내부에 정의
          Future<void> pickDate(bool isStart) async {
            final picked = await showDatePicker(
              ...
              // locale 설정 제거 (앱의 MaterialApp에서 설정하는 것이 바람직)
            ...
            if (picked != null) {
              // 💡 [수정] setStateDialog를 사용하여 다이얼로그 상태 즉시 갱신
              setStateDialog(() {
                if (isStart) {
                  ...
                  // 종료 날짜가 시작 날짜보다 빠르면 시작 날짜도 업데이트
              ...
              children: [
                ...
                Row(
                  children: [
                    const Text('시작: '),
                    TextButton(
                      onPressed: () => pickDate(true), // 날짜 선택기 호출
                      child: Text(
                ...
                Row(
                  children: [
                    const Text('종료: '),
                    TextButton(
                      onPressed: () => pickDate(false), // 날짜 선택기 호출
                      child: Text(
                ...
                children: List.generate(totalDays, (index) {
                  ...
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: isToday ? Colors.blue.withOpacity(0.1) : null, // withValues -> withOpacity 수정
                    ),
                    child: Column(
                        ...
                        children: List.generate(totalDays, (index) {
                          ...
                          return Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              color: isToday ? Colors.blue.withOpacity(0.05) : null, // withValues -> withOpacity 수정
                            ),
                          );
                        }),
                      ),
                          ...
                          return Positioned(
                            ...
                            child: GestureDetector(
                              ...
                              child: Tooltip(
                                ...
                                child: Container(
                                  decoration: BoxDecoration(
                                    color: m.isCompleted ? Colors.grey : m.color.withOpacity(0.8), // withValues -> withOpacity 수정
                                    borderRadius: BorderRadius.circular(6),
                                    boxShadow: [
                                      BoxShadow(color: Colors.black.withOpacity(0.1), blurRadius: 2, offset: const Offset(1, 1)) // withValues -> withOpacity 수정
                                    ],
                                  ),
